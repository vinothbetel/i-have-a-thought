...
export function TimeTrackingWidget() {
  ...
  const estimatedSeconds = (trackingTask.estimatedTime || 25) * 60
  const progress = Math.min((currentSessionElapsedSeconds / estimatedSeconds) * 100, 100)
  const isOverEstimate = currentSessionElapsedSeconds > estimatedSeconds
