...
>(
  (
    ...
    const [isChatOpenMobile, setIsChatOpenMobile] = React.useState(false)
    ...
    const contextValue = React.useMemo<SidebarContext>(
      () => ({
        ...
        toggleSidebar,
        isChatOpenMobile,
        setChatOpenMobile: setIsChatOpenMobile,
      }),
      [state, open, setOpen, isMobile, openMobile, setOpenMobile, toggleSidebar, isChatOpenMobile]
    )
